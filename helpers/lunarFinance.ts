 ...
 * Backend filters `source_chain_id` / `target_chain_id` with numeric chain IDs.
 */
export const LUNAR_CHAIN_ID: Record<string, number> = {
  ethereum: 1,
  arbitrum: 42161,
  optimism: 10,
  polygon: 137,
...
export async function fetchLunarAnalytics(
  ...
  return fetchURL(url) as Promise<LunarAnalyticsEnvelope>;
}
