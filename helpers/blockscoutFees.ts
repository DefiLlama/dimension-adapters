...
export const chainConfigMap: any = {
  ...
  [CHAIN.CELO]: {
    ...
    CGToken: "celo",
    allStatsApi: "https://stats-celo-mainnet.k8s-prod-2.blockscout.com",
  },
  [CHAIN.AURORA]: {
    explorer: "https://aurorascan.dev",
    allStatsApi: "https://stats.explorer.mainnet.aurora.dev",
    CGToken: "ethereum",
  },
  [CHAIN.XDAI]: {
    explorer: "https://blockscout.com/xdai/mainnet",
    CGToken: "dai",
    allStatsApi: "https://stats-gnosis-mainnet.k8s-prod-1.blockscout.com",
    start: "2018-11-01",
  },
  [CHAIN.CANTO]: {
    explorer: "https://explorer.plexnode.wtf",
    CGToken: "canto",
  },
  [CHAIN.CRONOS]: {
    explorer: "https://cronos.org/explorer",
    CGToken: "crypto-com-chain",
  },
  [CHAIN.MIXIN]: { explorer: "https://scan.mvm.dev", CGToken: "mixin" },
  [CHAIN.ENERGYWEB]: {
    explorer: "https://explorer.energyweb.org",
    CGToken: "energy-web-token",
  },
  [CHAIN.IMX]: {
    explorer: "https://explorer.immutable.com",
    CGToken: "immutable-x",
    allStatsApi: "https://stats-immutable-mainnet.k8s.blockscout.com",
  },
  [CHAIN.ZETA]: {
  ...
  [CHAIN.ETHERLINK]: {
    ...
    CGToken: "tezos",
    allStatsApi: "https://stats-etherlink-mainnet.k8s-prod-1.blockscout.com",
  },
  [CHAIN.REDSTONE]: {
    explorer: "https://explorer.redstone.xyz",
    CGToken: "ethereum",
    allStatsApi: "https://stats-redstone.k8s.blockscout.com",
  },
  [CHAIN.SHIMMER_EVM]: {
  ...
  [CHAIN.ROOTSTOCK]: {
    ...
    CGToken: "rootstock",
    allStatsApi: "https://stats-rsk-mainnet.k8s-prod-2.blockscout.com",
  },
  ...
  [CHAIN.FUSE]: {
    ...
    CGToken: "fuse-network-token",
    allStatsApi: "https://stats-fuse-mainnet.k8s-prod-1.blockscout.com",
  },
  [CHAIN.POLYGON]: {
    explorer: "https://polygon.blockscout.com",
    CGToken: "matic-network",
    allStatsApi: "https://stats-polygon-mainnet.k8s-prod-3.blockscout.com",
  },
  // [CHAIN.MANTA]: { explorer: 'https://pacific-explorer.manta.network', CGToken: 'ethereum' },
  [CHAIN.MINT]: {
    explorer: "https://explorer.mintchain.io",
    CGToken: "ethereum",
    allStatsApi: "https://explorer-mint-mainnet-0.t.conduit.xyz",
  },
  [CHAIN.OAS]: { explorer: "https://explorer.oasys.games", CGToken: "oasys" },
  [CHAIN.KROMA]: {
    explorer: "https://blockscout.kroma.network",
    CGToken: "ethereum",
    allStatsApi: "https://blockscout.kroma.network",
  },
  ...
  [CHAIN.BLAST]: {
    ...
    CGToken: "ethereum",
    allStatsApi: "https://stats-blast-mainnet.k8s-prod-1.blockscout.com",
  },
  // [CHAIN.LINEA]: { explorer: 'https://explorer.linea.build', CGToken: 'ethereum' },
  [CHAIN.MANTLE]: {
    explorer: "https://explorer.mantle.xyz",
    CGToken: "mantle",
    allStatsApi: "https://mantle-blockscout-stats.mantle.xyz",
  },
  [CHAIN.MODE]: {
    explorer: "https://explorer.mode.network",
    CGToken: "ethereum",
    allStatsApi: "https://explorer-mode-mainnet-0.t.conduit.xyz",
  },
  [CHAIN.SCROLL]: {
  ...
  [CHAIN.UNICHAIN]: {
    ...
    CGToken: "ethereum",
    allStatsApi: "https://stats-uniswap-mainnet.k8s-prod-2.blockscout.com",
  },
  [CHAIN.LISK]: {
    explorer: "https://blockscout.lisk.com",
    CGToken: "ethereum",
    allStatsApi: "https://stats-lisk-mainnet.k8s.blockscout.com",
  },
  [CHAIN.STORY]: {
    explorer: "https://www.storyscan.io",
    CGToken: "story-2",
    allStatsApi: "https://stats-story-mainnet.k8s-prod-3.blockscout.com",
  },
  [CHAIN.APECHAIN]: {
  ...
  [CHAIN.HEMI]: {
    ...
    CGToken: "ethereum",
    allStatsApi: "https://explorer.hemi.xyz",
  },
  ...
  [CHAIN.THUNDERCORE]: {
    ...
    CGToken: "thunder-token",
  },
  [CHAIN.CHILIZ]: { explorer: "https://scan.chiliz.com", CGToken: "chiliz" },
  [CHAIN.SUPERPOSITION]: {
    explorer: "https://explorer.superposition.so",
    CGToken: "ethereum",
    allStatsApi: "https://explorer-superposition-1v9rjalnat.t.conduit.xyz",
  },
  [CHAIN.BOB]: {
    explorer: "https://explorer.gobob.xyz",
    CGToken: "ethereum",
    allStatsApi: "https://explorer-bob-mainnet-0.t.conduit.xyz",
  },
  [CHAIN.REYA]: {
    explorer: "https://explorer.reya.network",
    CGToken: "ethereum",
    allStatsApi: "https://stats-reya-mainnet.k8s-prod-3.blockscout.com",
  },
  [CHAIN.SWELLCHAIN]: {
    explorer: "https://explorer.swellnetwork.io/",
    CGToken: "ethereum",
    allStatsApi: "https://explorer.swellnetwork.io",
  },
  [CHAIN.ZORA]: {
    explorer: "https://explorer.zora.co",
    CGToken: "ethereum",
    allStatsApi: "https://explorer.zora.co",
  },
  [CHAIN.WC]: {
    explorer: "https://worldchain-mainnet.explorer.alchemy.com",
    CGToken: "ethereum",
    allStatsApi: "https://stats-alchemy-worldchain-mainnet.k8s.blockscout.com",
  },
  ...
  [CHAIN.ANCIENT8]: {
    ...
    CGToken: "ethereum",
    allStatsApi: "https://explorer-ancient8-mainnet-0.t.conduit.xyz",
  },

  [CHAIN.GRAVITY]: {
    explorer: "https://explorer.gravity.xyz",
    CGToken: "g-token",
    allStatsApi: "https://explorer-gravity-mainnet-0.t.conduit.xyz",
  },
  [CHAIN.CORN]: {
    explorer: "https://maizenet-explorer.usecorn.com",
    CGToken: "wrapped-bitcoin",
    allStatsApi: "https://explorer-corn-maizenet.t.conduit.xyz",
  },
  ...
  [CHAIN.LIGHTLINK_PHOENIX]: {
    ...
    CGToken: "lightlink",
    allStatsApi: "https://stats-lightlink-phoenix.k8s.blockscout.com",
  },
  [CHAIN.IOTAEVM]: {
    CGToken: "iota",
    explorer: "https://explorer.evm.iota.org",
    allStatsApi: "https://stats-iota-evm.k8s.blockscout.com",
  },
  [CHAIN.FILECOIN]: {
    CGToken: "filecoin",
    explorer: "https://filecoin.blockscout.com/",
    allStatsApi: "https://stats-filecoin.k8s-prod-1.blockscout.com",
  },
  [CHAIN.HASHKEY]: {
    CGToken: "hashkey-ecopoints",
    explorer: "https://hashkey.blockscout.com",
    allStatsApi: "https://stats-hashkey-mainnet.k8s.blockscout.com",
    start: "2025-03-09",
  },
  [CHAIN.KARAK]: {
    CGToken: "ethereum",
  ...
  [CHAIN.SANKO]: {
    CGToken: "dream-machine-token",
    explorer: "https://explorer.sanko.xyz/",
  },
  [CHAIN.ALIENX]: {
    CGToken: "ethereum",
    explorer: "https://explorer.alienxchain.io/api",
  },
  [CHAIN.ADVENTURE_LAYER]: {
    CGToken: "adventure-gold",
    explorer: "https://advlayer-mainnet.cloud.blockscout.com/",
  },
  [CHAIN.DERI_CHAIN]: {
    CGToken: "ethereum",
    explorer: "https://explorer-dchain.deri.io/",
  },
  [CHAIN.EARNM]: {
    CGToken: "earnm",
    explorer: "https://earnm-mainnet.explorer.alchemy.com/",
  },
  [CHAIN.DUCK_CHAIN]: {
    CGToken: "the-open-network",
  ...
  [CHAIN.EVERCLEAR]: {
    CGToken: "ethereum",
    explorer: "https://scan.everclear.org/",
  },
  ...
  [CHAIN.MOLTEN_NETWORK]: {
    CGToken: "molten-2",
    explorer: "https://molten.calderaexplorer.xyz/",
  },
  [CHAIN.SYNDICATE]: {
    CGToken: "syndicate-3",
    explorer: "https://explorer.syndicate.io/",
  },
  [CHAIN.XCHAIN]: {
    CGToken: "ethereum",
    explorer: "https://xchain-explorer.kuma.bid/",
  },
  [CHAIN.NEOX]: { CGToken: "gas", explorer: "https://xexplorer.neo.org/" },
};
    ...
    adapter: {
      [chain]: {
        fetch: async (
          _timestamp: number,
          _: ChainBlocks,
          { chain, createBalances, startOfDay }: FetchOptions,
        ) => {
          ...
          if (getEnv("BLOCKSCOUT_BULK_MODE")) {
            if (allStatsApi && !gasData[chain]) {
              ...
              const { chart } = await httpGet(
                `${allStatsApi}/api/v1/lines/txnsFee?resolution=DAY`,
                requestConfig,
              );
              gasData[chain] = {};
            ...
            if (
              ...
              !attemptedToPullCGTokenPrice[CGToken]
            ) {
              attemptedToPullCGTokenPrice[CGToken] = true;
              console.log("pulling CG data for", CGToken);
              const { prices } = await httpGet(
                `https://pro-api.coingecko.com/api/v3/coins/${CGToken}/market_chart?vs_currency=usd&days=max&interval=daily`,
                {
                  headers: {
          ...
          if (chain == CHAIN.CANTO && CGToken)
            dailyFees.addCGToken(
              CGToken,
              (fees.gas_used_today * fees.gas_prices.average) / 1e18,
            );
