...
const adapter: SimpleAdapter = {
  ...
  methodology: {
    PremiumVolume: "Sum of token inflows into Exotic Markets vault token accounts identified in vaults.json; these represent option premiums paid by users",
    NotionalVolume: "Sum of token outflows from the same vault token accounts; these represent payouts/settlements to users",
  },
};
