...
const adapter: SimpleAdapter = {
  ...
  adapter: chainConfig,
  methodology: {
    Volume: 'Same-chain swap volume executed through LI.FI for integrator "hyperdex": the input amount of every LiFiGenericSwapCompleted log carrying that integrator, whitelisted tokens only.',
  },
}
