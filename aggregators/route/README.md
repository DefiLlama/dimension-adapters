...
The separate proposed `Liquidity Funding` breakdown is the full budget assigned to LP in completed cycles, not dedicated buybacks or exact deposited value. Whether that broader capital-allocation series can be displayed alongside holder revenue remains a separate maintainer classification decision; this funding reconciliation does not establish LP budgets as holder income.
