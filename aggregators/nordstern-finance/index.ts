...
const chainConfig: Record<string, { id: number, start: string }> = {
    ...
    [CHAIN.ANCIENT8]: { id: 888888888, start: commonStartTime },
    [CHAIN.APPCHAIN]: { id: 466, start: commonStartTime },
    [CHAIN.ARBITRUM_NOVA]: { id: 42170, start: commonStartTime },
    [CHAIN.B3]: { id: 8333, start: commonStartTime },
    [CHAIN.BEAM]: { id: 4337, start: commonStartTime },
    cyber: { id: 7560, start: commonStartTime },
    electroneum: { id: 52014, start: commonStartTime },
    [CHAIN.ELYS]: { id: 1339, start: commonStartTime },
    funki: { id: 33979, start: commonStartTime },
    [CHAIN.GENESYS]: { id: 16507, start: commonStartTime },
    [CHAIN.GENSYN]: { id: 685689, start: commonStartTime },
    [CHAIN.GOAT]: { id: 2345, start: commonStartTime },
    [CHAIN.HASHKEY]: { id: 177, start: commonStartTime },
    [CHAIN.KATANA]: { id: 747474, start: commonStartTime },
    [CHAIN.KCC]: { id: 321, start: commonStartTime },
    [CHAIN.KLAYTN]: { id: 8217, start: commonStartTime },
    [CHAIN.KUB]: { id: 96, start: commonStartTime },
    [CHAIN.MAP]: { id: 22776, start: commonStartTime },
    [CHAIN.MONAD]: { id: 143, start: commonStartTime },
    muster: { id: 4078, start: commonStartTime },
    parex: { id: 322202, start: commonStartTime },
    [CHAIN.PHAROS]: { id: 1672, start: commonStartTime },
    platon: { id: 210425, start: commonStartTime },
    [CHAIN.PLASMA]: { id: 9745, start: commonStartTime },
    [CHAIN.Q_PROTOCOL]: { id: 35441, start: commonStartTime },
    [CHAIN.REDSTONE]: { id: 690, start: commonStartTime },
    [CHAIN.REYA]: { id: 1729, start: commonStartTime },
    [CHAIN.ROBINHOOD]: { id: 4663, start: commonStartTime },
    rss3vsl: { id: 12553, start: commonStartTime },
    [CHAIN.SHAPE]: { id: 360, start: commonStartTime },
    [CHAIN.SHIBARIUM]: { id: 109, start: commonStartTime },
    [CHAIN.SONGBIRD]: { id: 19, start: commonStartTime },
    [CHAIN.SSEED]: { id: 5330, start: commonStartTime },
    [CHAIN.STEP]: { id: 1234, start: commonStartTime },
    [CHAIN.WEMIX]: { id: 1111, start: commonStartTime },
    [CHAIN.OG]: { id: 16661, start: commonStartTime },
    [CHAIN.WC]: { id: 480, start: commonStartTime },
    [CHAIN.XDAI]: { id: 100, start: commonStartTime },
};
