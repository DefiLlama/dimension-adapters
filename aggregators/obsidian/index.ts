...
const contracts = {
  [CHAIN.CRONOS]: getAddress("0xeb02A792A9a85c00498A72b13B9aA5c486bC6cA1"),
  [CHAIN.CRONOS_ZKEVM]: getAddress("0xDb0837D207708F55549a425638de3E2f53Eea141"),
};

const fetch = async ({ createBalances, getLogs, chain }: FetchOptions) => {
  const routerAddress = contracts[chain].toLowerCase();
