...
const chainConfig: Record<string, ChainConfig> = {
  ...
  [CHAIN.AVAX]: { start: "2024-02-02", directAddress: DIRECT_FORWARDER, contractAddress: CONTRACT_FORWARDER, lzContract: GAS_LZ_V2 },
  ...
  [CHAIN.WC]: { start: "2024-11-27", directAddress: DIRECT_FORWARDER, contractAddress: CONTRACT_FORWARDER },
  ...
  [CHAIN.HYPERLIQUID]: { start: "2025-02-18", directAddress: DIRECT_FORWARDER, contractAddress: CONTRACT_FORWARDER },
  ...
  [CHAIN.SSEED]: { start: "2025-04-09", directAddress: DIRECT_FORWARDER, contractAddress: CONTRACT_FORWARDER },
  ...
  [CHAIN.KLAYTN]: { start: "2025-07-11", directAddress: DIRECT_FORWARDER, contractAddress: CONTRACT_FORWARDER },
  ...
  [CHAIN.ERA]: { start: "2024-09-25", directAddress: DIRECT_FORWARDER, contractAddress: "0x252fb662e4d7435d2a5ded8ec94d8932cf76c178" },
  ...
  [CHAIN.PLUME]: { start: "2025-05-27", directAddress: DIRECT_FORWARDER, contractAddress: "0xc62155f48D2aEE12FFF6Bb3b7946385d3A98854C" },
...
const fetch = async (options: FetchOptions) => {
  ...
  await getETHReceived({ options, balances: dailyBridgeVolume, target: config.directAddress })
