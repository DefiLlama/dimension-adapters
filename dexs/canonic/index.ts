...
const MAOBS = [
    { address: '0xaD7e5CBfB535ceC8d2E58Dca17b11d9bA76f555E', base: ADDRESSES.ethereum.BTC_b, quote: USDM },  // BTC.b / USDm
    { address: '0x23469683e25b780DFDC11410a8e83c923caDF125', base: ADDRESSES.optimism.WETH_1, quote: USDM },  // WETH  / USDm
    { address: '0xDf1576c3C82C9f8B759C69f4cF256061C6Fe1f9e', base: ADDRESSES.corn.USDT0, quote: USDM },  // USDT0 / USDm
    { address: '0x20C7B6B34bB8B8efb46828cF9383BFf8b7856E46', base: ADDRESSES.megaeth.MEGA, quote: USDM },  // MEGA  / USDm
]
