...
const adapter: SimpleAdapter = {
  ...
  start: "2026-08-12",
  methodology: {
    Volume: "Quote-side notional of every swap on a bonding curve launched through Archade, from any interface: the input on a buy, the output on a sell. Decoded from the curve program's own swap events and reconciled against each pool's lifetime counters.",
  },
};
