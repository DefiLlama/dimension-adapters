...
// Latest deployments
const CTF_EXCHANGE = "0x03C6c6fbdc0c719Dc878fCe24deBaBC31B2B4a27";
const NEG_RISK_CTF_EXCHANGE = "0x90B036c618196634200F0323c420C50CdBBCf07C"
const CROSS_MATCHING_ADAPTER = "0xd3460060A8363C24babC411a11444d5d985342EF";

// Legacy (previous latest)
const NEG_RISK_CTF_EXCHANGE_LEGACY = "0x3d6726aF35Ae695E056e6e2ebDB5c813b7d8B6CC";
const CROSS_MATCHING_ADAPTER_LEGACY = "0x74AD4708928628c20608F10751EaFBE391197b0F";

const NEG_RISK_CTF_EXCHANGE_LEGACY_V2 = "0xcc9D4EA7c86f2d6d67a44BC5e7A8932699ddDDa1";
...
const fetch = async (options: FetchOptions) => {
  const { dailyVolume, dailyNotionalVolume } = await getPolymarketVolume({
    ...
    exchanges: [
      ...
      NEG_RISK_CTF_EXCHANGE_LEGACY_V2,
      CROSS_MATCHING_ADAPTER_LEGACY_V2,
      NEG_RISK_CTF_EXCHANGE_LEGACY_V3,
