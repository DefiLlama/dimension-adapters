...
const kyberswapElasticV2 = univ2Adapter2({
...
const elasticChains = ["ethereum", "optimism"]//, "polygon", "bsc", "avax", "fantom", "arbitrum", "optimism"]
...
const elasticGraphs = getChainVolume2({
...
const optimismElastic = async (timestamp: number) => {
  ...
  const response: any[] = (await request(url, query)).poolDayDatas;
...
const classicGraphs = getChainVolume2({
