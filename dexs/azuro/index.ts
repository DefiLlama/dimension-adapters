...
const adapter: Adapter = {
  ...
  fetch,
  adapter: {
    [CHAIN.POLYGON]: { start: "2022-12-01" },
    [CHAIN.XDAI]: { start: "2022-01-01", deadFrom: "2025-12-01" },
    [CHAIN.BASE]: { start: "2024-02-01" },
    [CHAIN.ARBITRUM]: { start: "2023-06-01", deadFrom: "2023-12-23" },
    [CHAIN.LINEA]: { start: "2023-08-01", deadFrom: "2024-03-30" },
    [CHAIN.CHILIZ]: { start: "2024-07-09", deadFrom: "2025-05-06" },
  },
