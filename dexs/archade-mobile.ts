...
const adapter: SimpleAdapter = {
  ...
  doublecounted: true,
  methodology: {
    Volume: "USD notional of swaps executed by users through the Archade mobile app (iOS and Android), priced at the SOL price recorded on each trade. Routed to the venue with the liquidity, so it is also counted there.",
  },
};
