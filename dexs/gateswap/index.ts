...
const adapter: SimpleAdapter = {
  ...
  adapter: {
    [CHAIN.GATE_LAYER]: { fetch: GATE_LAYER_FETCH, start: '2025-09-27' },
    [CHAIN.ETHEREUM]: { fetch: EVM_ROUTER_FETCH, start: '2025-09-27' },
    [CHAIN.ARBITRUM]: { fetch: EVM_ROUTER_FETCH, start: '2025-09-27' },
    [CHAIN.OPTIMISM]: { fetch: EVM_ROUTER_FETCH, start: '2025-09-27' },
    [CHAIN.BASE]: { fetch: EVM_ROUTER_FETCH, start: '2025-09-27' },
    [CHAIN.POLYGON]: { fetch: EVM_ROUTER_FETCH, start: '2025-09-27' },
