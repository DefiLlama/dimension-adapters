...
// Archery concentrated liquidity (Slipstream-style) factory and deployment block on Arc.
// Source: Archery mainnet deployment manifest; deploy tx is verifiable on https://explorer.arc.io
const CONFIG = {
  clFactory: "0xc481038c013fe96f38ce7a2dc417b2b1b78b16a4",
  clFactoryStartBlock: 22447744,
};

// CLPool.fee returns Uniswap-V3-style pips. The factory uses a dynamic swap fee module, so the
// fee read at the end of the window is applied to swaps in that window (hourly pulls keep this tight).
