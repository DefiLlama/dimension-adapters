...
const fetchLinea = async (options: FetchOptions) => {
  const univ3Adapter = getUniV3LogAdapter({ factory: '0x9Fe607e5dCd0Ea318dBB4D8a7B04fa553d6cB2c5', revenueRatio: 0, })
  const algebraAdapter = getUniV3LogAdapter({ factory: '0xec4f2937e57a6F39087187816eCc83191E6dB1aB', isAlgebraVe: true, poolCreatedEvent, swapEvent, revenueRatio: 0, })
...
const adapter: SimpleAdapter = {
  ...
  adapter: {
    ...
    [CHAIN.BASE]: { fetch: getUniV3LogAdapter({ factory: '0x07AceD5690e09935b1c0e6E88B772d9440F64718', revenueRatio: 0, }) },
  },
}
