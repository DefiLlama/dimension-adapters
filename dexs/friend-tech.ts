...
const fetch = async ({ getLogs, createBalances }: FetchOptions) => {
  ...
  const clubBuy = await getLogs({
    target: "0x201e95f275f39a5890c976dc8a3e1b4af114e635",
  ...
  clubBuy.forEach((e: any) => dailyVolume.add("0x0bd4887f7d41b35cd75dff9ffee2856106f86670", e.pointsIn));
  clubSell.forEach((e: any) => dailyVolume.add("0x0bd4887f7d41b35cd75dff9ffee2856106f86670", e.pointsOut));
