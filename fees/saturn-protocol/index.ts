...
const fetch = async (options: FetchOptions) => {
    ...
    // Saturn returns 10% of revenue to sUSDat holders, so the protocol keeps 90%.
    return {
        dailyFees,
        dailyRevenue,
        dailySupplySideRevenue,
        dailyProtocolRevenue: dailyRevenue.clone((BPS - HOLDERS_REVENUE_BPS) / BPS),
        dailyHoldersRevenue: dailyRevenue.clone(HOLDERS_REVENUE_BPS / BPS),
    };
};
...
const methodology = {
    ...
    ProtocolRevenue: "Saturn keeps 90% of revenue (sUSDat deposit fees and 10% performance fee on sUSDat yield); the remaining 10% of revenue is returned to sUSDat holders.",
    HoldersRevenue: "10% of revenue returned to sUSDat holders.",
...
const breakdownMethodology = {
    ...
    // 10% of each revenue component is returned to sUSDat holders (dailyHoldersRevenue is 10% of revenue).
    HoldersRevenue: {
        [METRIC.DEPOSIT_WITHDRAW_FEES]: "Holders' 10% share of deposit fees.",
        [METRICS.STRC_PERFORMANCE_FEE]: "Holders' 10% share of the performance fee on STRC rewards.",
        [METRICS.USDAT_PERFORMANCE_FEE]: "Holders' 10% share of the performance fee on Tbill yields.",
        [METRICS.USDAT_YIELD_TO_PROTOCOL]: "Holders' 10% share of Tbill yields that don't back sUSDat.",
    },
};
