...
const mapTokenPrice: IMap = {
  ['0x101816545f6bd2b1076434b54383a1e633390a2e'.toLowerCase()]: 'ethereum:' + ADDRESSES.null,
  ['0x915a55e36a01285a14f05de6e81ed9ce89772f8e'.toLowerCase()]: 'ethereum:' + ADDRESSES.null,
  ['0xd22363e3762ca7339569f3d33eade20127d5f98c'.toLowerCase()]: 'ethereum:' + ADDRESSES.null,
  ['0x892785f33CdeE22A30AEF750F285E18c18040c3e'.toLowerCase()]: 'ethereum:' + ADDRESSES.ethereum.USDC,
  ['0xB6CfcF89a7B22988bfC96632aC2A9D6daB60d641'.toLowerCase()]: 'ethereum:' + ADDRESSES.ethereum.USDT,
  ['0x38EA452219524Bb87e18dE1C24D3bB59510BD783'.toLowerCase()]: 'ethereum:' + ADDRESSES.ethereum.USDT, // USDT
  ['0xdf0770dF86a8034b3EFEf0A1Bb3c889B8332FF56'.toLowerCase()]: 'ethereum:' + ADDRESSES.ethereum.USDC, // USDC
  ['0x1205f31718499dBf1fCa446663B532Ef87481fe1'.toLowerCase()]: 'ethereum:' + ADDRESSES.ethereum.USDC,
  ['0x29e38769f23701A2e4A8Ef0492e19dA4604Be62c'.toLowerCase()]: 'ethereum:' + ADDRESSES.ethereum.USDT,
  ['0x9aA83081AA06AF7208Dcc7A4cB72C94d057D2cda'.toLowerCase()]: 'ethereum:' + ADDRESSES.ethereum.USDT,
  ['0x98a5737749490856b401DB5Dc27F522fC314A4e1'.toLowerCase()]: 'coingecko:binance-usd',
  ['0x12edeA9cd262006cC3C4E77c90d2CD2DD4b1eb97'.toLowerCase()]: 'ethereum:' + ADDRESSES.ethereum.USDC,
  ['0xDecC0c09c3B5f6e92EF4184125D5648a66E35298'.toLowerCase()]: 'ethereum:' + ADDRESSES.ethereum.USDC
}
