...
const adapter: any = {}
const config: any = {
  arbitrum: { start: '2023-09-06', tokens: ['0xaf88d065e77c8cc2239327c5edb3a432268e5831'], fromAddressFilter: '0x5f98f630009E0E090965fb42DDe95F5A2d495445' },
  base: { start: '2023-08-25', tokens: ['0xd9aAEc86B65D86f6A7B5B1b0c42FFA531710b6CA'], fromAddressFilter: '0x02ae4716b9d5d48db1445814b0ede39f5c28264b'},
  polygon: { start: '2023-09-06', tokens: ['0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174'], logFilter: polygonLogFilter},
  avax: { start: '2023-09-06', tokens: ['0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E'], },
  optimism: { start: '2023-08-25', tokens: ['0x7F5c764cBc14f9669B88837ca1490cCa17c31607'], },
  bsc: { start: '2023-08-25', tokens: ['0x55d398326f99059fF775485246999027B3197955'], },
  ethereum: { start: '2023-08-25', tokens: ['0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48'], targets: ['0x65f2145693bE3E75B8cfB2E318A3a74D057e6c7B'],  logFilter: ethereumLogFilter, },
  linea: { start: '2024-03-10', tokens: ['0x176211869cA2b568f2A7D4EE941E073a821EE1ff'], },
}
