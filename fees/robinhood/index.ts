...
const fetch = async (options: FetchOptions) => {
  ...
  dailyRevenue.addGasToken(netFees - aepFee, METRIC.TRANSACTION_GAS_FEES);
...
const adapter: Adapter = {
  ...
  methodology: {
    ...
    Revenue: "Transaction gas fees net of Ethereum L1 execution and blob costs and the 10% Arbitrum Expansion Program fee share.",
    SupplySideRevenue: "Ethereum L1 execution and blob costs paid for Robinhood Chain batch posting and rollup assertion transactions, plus the 10% Arbitrum Expansion Program share of net revenue paid to the Arbitrum DAO and developer fund.",
  },
  breakdownMethodology: {
    ...
    Revenue: {
      [METRIC.TRANSACTION_GAS_FEES]: "L2 transaction gas fees net of Ethereum L1 settlement costs and the Arbitrum Expansion Program fee share.",
    },
    SupplySideRevenue: {
