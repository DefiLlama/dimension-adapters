...
const fetch = async (options: FetchOptions) => {
  ...
  // ! check if this is correct - no record (income too low) 12/25
  //   const liquidationProfit = await options.getLogs({
  //     target: lisUSD,
  //     topics: [
  //       transferHash,
  //       "0x9bA88e6b20041750Fd4e6271fEa455F5D44063Cb",
  //       oldTreasury,
  //     ],
  //   });
  //   const liquidationProfitNew = await options.getLogs({
  //     target: lisUSD,
  //     topics: [
  //       transferHash,
  //       "0x9bA88e6b20041750Fd4e6271fEa455F5D44063Cb",
  ...
  // todo: collect auto compound fee 12/25
  ...
  //   [...liquidationProfit, ...liquidationProfitNew].forEach((log) => {
  //     const amount = Number(log.data);
  //     dailyFees.add(lisUSD, amount);
  //   });
