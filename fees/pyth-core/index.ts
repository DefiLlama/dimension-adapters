...
const evmChainConfig: Record<string, { start: string; contract: string }> = {
  ...
  [CHAIN.XDAI]: { start: "2023-07-01", contract: "0x2880aB155794e7179c9eE2e38200202908C17B43" },
  ...
  [CHAIN.WC]: { start: "2024-10-01", contract: "0xe9d69cdd6fe41e7b621b4a688c5d1a68cb5c8adc" },
  ...
  [CHAIN.SWELLCHAIN]: { start: "2024-12-01", contract: "0xDd24F84d36BF92C65F92307595335bdFab5Bbd21" },
