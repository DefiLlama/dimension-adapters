...
const USDTReserveKey =
  "0x9770fa9c725cbd97eb50b2be5f7416efdfd1f1554beb0750d4dae4c64e860da3::fa_to_coin_wrapper::WrappedUSDT";
const USDCReserveKey =
...
const fetch = async (timestamp: number, _: any, options: FetchOptions) => {
  ...
  for (const reserveKey of [USDTReserveKey, USDCReserveKey]) {
    const dayFeesQuery = (
      await fetchURL(
        `${rateURL}{%22fromTs%22:${timestamp},%22resolutionInHours%22:24,%22reserveKey%22:%22${reserveKey}%22}`
