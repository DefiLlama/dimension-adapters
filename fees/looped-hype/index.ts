...
const adapter: Adapter = {
  ...
  methodology: {
    ...
    Revenue: "The share of staking rewards and fees for Looping Collective.",
    ProtocolRevenue: "The share of staking rewards and fees for Looping Collective.",
    SupplySideRevenue: "The share of yield distributed to LHYPE depositors.",
  },
  fetch,
