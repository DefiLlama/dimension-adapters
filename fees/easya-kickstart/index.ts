...
const methodology = {
    Fees:
        'Total swap fees paid by users on Kickstart bonding curves plus all post-migration DAMM v2 LP fees generated by Kickstart-launched pools. DBC swap fees include trading_fee + protocol_fee + referral_fee from Meteora DBC swap events.',
    Revenue:
