...
const WRAPPED_NATIVE: { [chain: string]: string } = {
  ...
  base: ADDRESSES.optimism.WETH_1,
  ...
  monad: ADDRESSES.monad.WMON,
}

// source: https://github.com/Folks-Finance/xchain-js-sdk
const HUB_POOLS: { [chain: string]: Array<{ pool: string; token: string }> } = {
  avax: [
    { pool: '0x88f15e36308ED060d8543DA8E2a5dA0810Efded2', token: ADDRESSES.avax.USDC },
    { pool: '0x0259617bE41aDA4D97deD60dAf848Caa6db3F228', token: 'native' },
    { pool: '0x7033105d1a527d342bE618ab1F222BB310C8d70b', token: ADDRESSES.avax.SAVAX },
    { pool: '0x795CcF6f7601edb41E4b3123c778C56F0F19389A', token: ADDRESSES.avax.WETH_e },
    { pool: '0x1C51AA1516e1156d98075F2F64e259906051ABa9', token: ADDRESSES.avax.BTC_b },
    { pool: '0x307bCEC89624660Ed06C97033EDb7eF49Ab0EB2D', token: '0xbc78D84Ba0c46dFe32cf2895a19939c86b81a777' },
    { pool: '0x5e5a2007a8D613C4C98F425097166095C875e6eE', token: ADDRESSES.avax.JOE },
    ...
    { pool: '0xc7DdB440666c144c2F27a3a5156D636Bacfc769C', token: ADDRESSES.mantle.AUSD },
    { pool: '0xE6B7713854620076B5716E2743262D315bf8609D', token: '0x06d47F3fb376649c3A9Dafe069B3D6E35572219E' },
    { pool: '0xA1E1024c49c77297bA6367F624cFbEFC80E697c6', token: ADDRESSES.avax.USDt },
    { pool: '0x13A21bC65844CD530098Ab15431c57078ea90737', token: '0x2cd3CdB3bd68Eea0d3BE81DA707bC0c8743D7335' },
    { pool: '0x5431e7f480C4985e9C3FaAcd3Bd1fc7143eAdEFa', token: ADDRESSES.avax.USDe },
    { pool: '0x94307E63eF02Cf9B39894553f14b21378Ef20adB', token: ADDRESSES.avax.sUSDe },
    { pool: '0x3F87F3B301f031ba59C479EDF067621DcC72DDca', token: ADDRESSES.avax.EURC },
  ...
  ethereum: [
    ...
    { pool: '0x9936812835476504D6Cf495F4F0C718Ec19B3Aff', token: ADDRESSES.ethereum.WBTC },
    ...
    { pool: '0xe7897052FAC4bfF9EB3ABc073CBC1e17Fce5709C', token: ADDRESSES.ethereum.WSTETH },
    { pool: '0x4E6dD5E35638008cdB1E9004F3E952bCDd920E6D', token: ADDRESSES.ethereum.WEETH },
    { pool: '0xf51a72b92cB9C16376Da04f48eF071c966B9C50B', token: ADDRESSES.ethereum.USDT },
  ...
  base: [
    ...
    { pool: '0x9eD81F0b5b0E9b6dE00F374fFc7f270902576EF7', token: ADDRESSES.ethereum.cbBTC },
    { pool: '0xb5327c35E083248E3a0f79122FaB3b6018e5584a', token: ADDRESSES.base.AERO },
    { pool: '0x0b09E1Ffd28040654021A85A49284597F3d0e41C', token: ADDRESSES.base.cbETH },
    { pool: '0xC96820695217c7dd8F696f8892de76F7a48432CB', token: ADDRESSES.base.wstETH },
    { pool: '0xf727EC8D6e565328f2cf0Ff8aC4e7c9e7f8d24B2', token: ADDRESSES.bsc.weETH },
  ...
  bsc: [
    ...
    { pool: '0x18031B374a571F9e060de41De58Abb5957cD5258', token: ADDRESSES.bsc.ETH },
    { pool: '0xC2FD40D9Ec4Ae7e71068652209EB75258809e131', token: ADDRESSES.bsc.BTCB },
  ],
  arbitrum: [
    { pool: '0x44E0d0809AF8Ee37BFb1A4e75D5EF5B96F6346A3', token: 'native' },
    { pool: '0x1177A3c2CccDb9c50D52Fc2D30a13b2c3C40BCF4', token: ADDRESSES.arbitrum.ARB },
    { pool: '0x3445055F633fEF5A64F852aaCD6dA76143aCA109', token: ADDRESSES.arbitrum.WBTC },
    { pool: '0xdd9eFBf83572f5387381aD3A04b1318221d545A2', token: '0x6c84a8f1c29108F47a79964b5Fe888D4f4D0dE40' },
    { pool: '0x9f0c0aDEc9fd4ef946aCe1e2b4F32e49aE45C8F3', token: ADDRESSES.arbitrum.WSTETH },
    { pool: '0x78B4e5cda33C898b546dB7925162879E7bd2A9d1', token: ADDRESSES.arbitrum.weETH },
    { pool: '0x60f2682Ab38e3C9a51b07fbd69f42Ad2Cfe731db', token: ADDRESSES.berachain.rsETH },
    { pool: '0x1b5a1dCe059E6069Ed33C3656826Ad04bE536465', token: ADDRESSES.arbitrum.USDT },
  ],
  polygon: [
    { pool: '0x481cF0c02BF17a33753CE32f1931ED9990fFB40E', token: 'native' },
    { pool: '0x7054254933279d93D97309745AfbFF9310cdb570', token: ADDRESSES.polygon.WBTC },
    { pool: '0x88Ae56886233C706409c74c3D4EA9A9Ac1D65ab2', token: ADDRESSES.polygon.WETH_1 },
    { pool: '0xD77b920A9c05B3e768FEaE0bcB5839cd224328fE', token: ADDRESSES.polygon.WSTETH },
    { pool: '0x84C420D5e077cF0ed8a20c44d803C380172eD5D5', token: '0x53E0bca35eC356BD5ddDFebbD1Fc0fD03FaBad39' },
    { pool: '0x59023eFDB22B9d8b2C7aeD842aC1fd2f6110e5B5', token: ADDRESSES.polygon.MATICX },
    { pool: '0x34f1BA5808EB5Bf60c9B1C343d86e410466F4860', token: ADDRESSES.mantle.AUSD },
    { pool: '0x11f82b5Ea7408Ff257F6031E6A3e29203557A1DD', token: ADDRESSES.polygon.USDT },
  ],
  sei: [
    ...
    { pool: '0x7Cd4afD7F4DB51A0bF06Bf4630752A5B28e0B6C1', token: ADDRESSES.bsc.WBTC },
  ],
  monad: [
    { pool: '0x10a4481F79aAC209aC6c2959B785F2e303912Dc5', token: 'native' },
    { pool: '0xdc887aCFe154BF0048Ae15Cda3693Ab2C237431A', token: ADDRESSES.bsc.WBTC },
    { pool: '0xD7Ff49751DAF42Bf7AFC4fF5C958d4bea48358D3', token: ADDRESSES.monad.WETH },
    { pool: '0x5562d84f9891288fc72aaB1d857797c7275Fcedb', token: '0xA3227C5969757783154C60bF0bC1944180ed81B9' },
    { pool: '0x4fb4c3A33cBe855C5d87078c1BbBe5f371417faC', token: ADDRESSES.mantle.AUSD },
    { pool: '0xd9D50D4F73f61A306b47e5BdC825E98cd11139dc', token: ADDRESSES.flare.USDT0 },
