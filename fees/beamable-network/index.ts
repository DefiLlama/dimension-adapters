...
const adapter: SimpleAdapter = {
    ...
    methodology: {
        ...
        Revenue: "All fees collected by the protocol, distributed between workers and BMB stakers",
        SupplySideRevenue: "Portion of fees paid to worker nodes for providing computational resources",
