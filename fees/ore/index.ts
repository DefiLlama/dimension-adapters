...
const adapter: SimpleAdapter = {
  ...
  methodology: {
    Fees: 'Fees are collected from SOL deployed on ORE boards.',
    Revenue: 'Revenue is collected as 10% of total SOL deployed on each ORE board.',
    ProtocolRevenue: 'Protocol revenue is collected as 10% of total SOL deployed on each ORE board.',
  },
