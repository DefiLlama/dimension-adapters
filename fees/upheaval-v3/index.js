...
const methodology = {
  Fees: 'Trading fees from spot token volume where Upheaval is the deployer of the UPUP token.',
  Revenue: 'Trading fees from spot token volume where Upheaval is the deployer of the UPUP token.',
  ProtocolRevenue: 'Trading fees from spot token volume where Upheaval is the deployer of the UPUP token.',
