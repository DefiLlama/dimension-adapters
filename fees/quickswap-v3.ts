...
import { SimpleAdapter, BaseAdapter, FetchOptions, Dependencies } from "../adapters/types";
...
/*
QuickSwap V3 (Algebra/Uniswap v3 fork):
...
const adapter: SimpleAdapter = {
  ...
  adapter: Object.keys(config_v3).reduce((acc, chain) => {
    acc[chain] = {
      fetch: fetchv3Graph,
