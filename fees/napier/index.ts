...
const methodology = {
  ...
  ProtocolRevenue:
    "Protocol revenue is the portion of fees not distributed to curators (Curve markets) plus protocol reward tokens sent to treasury",
