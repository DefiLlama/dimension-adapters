...
const curatorConfig: CuratorConfig = {
  methodology: {
    Fees: 'Total fees were generated from all vaults curated by Steakhouse Financial.',
    Revenue: 'Amount of fees were collected by Steakhouse Financial from all curated vaults.',
  },
  vaults: {
    ethereum: {
      morpho: [
