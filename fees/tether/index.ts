  ...
  [
    {
      ...
      allocatedToGold: 19.8,
      allocatedToBitcoin: 6.6,
    },
    {
      time: '2025-12',
      circulation: 186.5,
      allocated: 122.3 + 19.3 + 5.5 + 17,
      allocatedToGold: 17.5,
      allocatedToBitcoin: 8.4,
    },
    {
      time: '2025-09',
      circulation: 174.4,
    ...
    },
    {
      ...
      tbillRate: 4.8,
      allocatedToGold: 3.4,
      allocatedToBitcoin: 1.5
    },
    {
      time: '2022-12',
      circulation: 66.3,
      allocated: 39.2 + 7.4 + 3.05 + 5.9, // not including BTC and gold as the exact allocations are not provided
      tbillRate: 4.3
    },
    {
      time: '2022-09',
      circulation: 67.9,
      allocated: 39.7 + 7.1 + 3.02 + 6.1, // not including BTC and gold as the exact allocations are not provided
      tbillRate: 3.22
    },
    {
      time: '2022-06',
      circulation: 66.5,
      allocated: 28.9 + 8.4 + 6.8 + 3 + 4.5, // not including BTC and gold as the exact allocations are not provided
      tbillRate: 1.66
    },
    {
      time: '2022-03',
      circulation: 82.6,
      allocated: 39.2 + 6.8 + 0.1 + 20.1 + 3.1, // not including BTC and gold as the exact allocations are not provided
      tbillRate: 0.51
    },
    {
      time: '2021-12',
      circulation: 78.34,
      allocated: 34.5 + 3 + 24.1 + 4.1 + 3.6 + 5.02, // not including BTC and gold as the exact allocations are not provided
      tbillRate: 0.05
    },
    {
      time: '2021-09',
      circulation: 69.2,
      allocated: 1 + 19.4 + 30.6 + 3.5, // not including BTC and gold as the exact allocations are not provided
      tbillRate: 0.04
    },
    {
      time: '2021-06',
      circulation: 62.8,
      allocated: 1 + 15.3 + 30.8 + 2.5, // not including BTC and gold as the exact allocations are not provided
      tbillRate: 0.04
    },
...
adapter.breakdownMethodology = {
  Fees: {
    ...
    'Gold Price PnL': 'PnL from gold price fluctuations.',
    'Bitcoin Price PnL': 'PnL from bitcoin price fluctuations.',
  },
  Revenue: {
