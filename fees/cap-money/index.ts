...
import { capABI, capConfig } from "./lib/config";
import { fetchAssetAddresses, fetchVaultConfigs } from "./lib/helpers";
...
const fetch = async (options: FetchOptions) => {
    ...
    dailySupplySideRevenue.addBalances(insuranceFundFees);
...
const methodology = {
    ...
    SupplySideRevenue:
        "Borrow fees distributed to stakers and restaker fees are distributed to delegators.",
};
