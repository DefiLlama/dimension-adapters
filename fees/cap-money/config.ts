...
export const capABI = {
    Vault: {
        ...
        interestReceiver: 'function interestReceiver() public view returns (address)',
    ...
    Lender: {
        ...
        ReserveInterestReceiverUpdatedEvent: 'event ReserveInterestReceiverUpdated(address indexed asset, address interestReceiver)',
        RealizeInterestEvent: 'event RealizeInterest(address indexed asset, uint256 realizedInterest, address interestReceiver)',
        RepayEvent: 'event Repay(address indexed asset, address indexed agent, (uint256 repaid, uint256 vaultRepaid, uint256 restakerRepaid, uint256 interestRepaid) details)',
    }
} as const
