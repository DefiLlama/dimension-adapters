...
const vSolAddress = "vSoLxydx6akxyMD9XEcPvGYNGq6Nn66oqVb3UkGkei7";
...
const fetch = async (options: FetchOptions) => {
  const fees = await queryDuneSql(
    ...
    WHERE account_mint = '${vSolAddress}'
...
const meta = {
  methodology: {
    Fees: 'Total yield rewards generated by the vault',
