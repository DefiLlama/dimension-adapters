...
// Fee per price feed update by chain
// Source: https://docs.pyth.network/price-feeds/core/current-fees
// Updated via OP-PIP-93: https://forum.pyth.network/t/passed-op-pip-93-q1-2026-pyth-core-fee-implementation-evm-chains/2346
const feePerUpdateByChain: Record<string, bigint> = {
  ...
  [CHAIN.SSEED]: 3_000_000_000_000n, // Superseed
  [CHAIN.SWELLCHAIN]: 3_000_000_000_000n,
  [CHAIN.TAIKO]: 3_000_000_000_000n,
  [CHAIN.UNICHAIN]: 3_000_000_000_000n,
  [CHAIN.WC]: 3_000_000_000_000n, // Worldchain
  [CHAIN.ERA]: 3_000_000_000_000n, // zkSync

  // Base (0.000015 ETH = 1.5e13 wei)
  [CHAIN.BASE]: 15_000_000_000_000n,

  // BNB chains (0.0000125 BNB = 1.25e13 wei)
  [CHAIN.BSC]: 12_500_000_000_000n,
  [CHAIN.OP_BNB]: 12_500_000_000_000n,

  // Avalanche (0.0005 AVAX = 5e14 wei)
  [CHAIN.AVAX]: 500_000_000_000_000n,

  // HyperEVM (0.0001 HYPE = 1e14 wei)
  [CHAIN.HYPERLIQUID]: 100_000_000_000_000n,

  // Chains with 0.1 native token fee (1e17 wei)
  ...
  // Chains with 0.01 native token fee (1e16 wei)
  ...
  [CHAIN.XDAI]: 10_000_000_000_000_000n, // Gnosis

  // Chains with 0.2 native token fee (2e17 wei)
  [CHAIN.APECHAIN]: 200_000_000_000_000_000n,
  [CHAIN.KLAYTN]: 200_000_000_000_000_000n, // Kaia
  [CHAIN.OG]: 200_000_000_000_000_000n, // 0G
...
// Default fee for chains not in the list (1 wei - legacy default)
...
const adapter: SimpleAdapter = {
  ...
  methodology: {
    Fees: "Fees paid by users to update Pyth price feeds on-chain. Fee amounts per chain are set by Pyth DAO governance.",
