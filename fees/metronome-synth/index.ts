...
const adapter: SimpleAdapter = {
  methodology: {
    Fees: "Tracks synth asset, AMO harvest, and recurring fee inflows to treasury.",
    Revenue: "Includes synth asset, AMO harvest, and recurring fee inflows and interest (converted to USD).",
