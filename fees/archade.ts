...
const methodology = {
  Volume: "USD notional of swaps executed by users through the Archade app, priced at the SOL price recorded on each trade.",
  Fees: "Archade's platform fee on every swap routed through the app, taken in the quote asset inside the swap transaction itself. 1% since June 2026, 0.5% before that. Reported at the amount actually taken.",
...
const breakdownMethodology = {
  Fees: { [METRIC.TRADING_FEES]: "Archade's platform fee on every swap routed through the app: 1% since June 2026, 0.5% before that." },
