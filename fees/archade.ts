...
const methodology = {
  ...
  Fees: "Everything users pay: the app's platform fee on each routed swap (1% since June 2026, 0.5% before), the full 1.25% bonding curve fee on coins launched through Archade, and the 0.02 SOL pool creation fee.",
  ...
  Revenue: "What Archade keeps: the whole app platform fee, its 0.70% share of each bonding curve trade, and 90% of each 0.02 SOL pool creation fee.",
  ProtocolRevenue: "Same as Revenue. All of it lands in the Archade treasury on Solana; there is no staking or holder leg.",
  SupplySideRevenue: "What Archade does not keep: the coin creator's 30% of the curve trading fee, the curve program's protocol share, the referral leg it hands to whichever interface hosted the swap, and its 10% of the pool creation fee.",
...
const breakdownMethodology = {
  ...
  Revenue: {
    ...
    [LABEL.CURVE_KEPT]: "Archade's 0.70% share of curve trades, claimable only by the config's fee claimer.",
