...
const fetch = async (_: any, _1: any, { dateString, createBalances }: FetchOptions) => {
  ...
  const dailyRevenue = dailyFees.clone(0.1); // 10% performance fees are revenue
  const dailySupplySideRevenue = dailyFees.clone(0.9); // 90% of the fees goes to the depositors
