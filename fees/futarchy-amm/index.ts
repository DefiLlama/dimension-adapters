/*
  ...
  2. Meteora DAMM Pools - LP fees from pools where Futarchy DAOs own 100% liquidity
...
const fetch = async (_a: any, _b: any, options: FetchOptions) => {
  ...
  const query = getSqlFromFile('helpers/queries/futarchy.sql', {
...
const breakdownMethodology = {
  Fees: {
    'futarchy_amm': '0.5% fee on Futarchy AMM SpotSwap transactions.',
