...
const methodology = {
  ...
  HoldersRevenue: "All cbBTC sent from the Treasury goes to STRI holders pro-rata. Pre-max-supply (500,000 STRI), 100% of distributions go to holders. After the supply cap is reached, the protocol begins retaining 5% for ongoing operations.",
