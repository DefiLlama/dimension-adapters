...
const breakdownMethodology = {
  Fees: {
    [METRIC.STAKING_REWARDS]: "Performance fees generated by Valdora liquid staking and active vault products, based on each product’s stated fee structure.",
  },
  Revenue: {
    [METRIC.PROTOCOL_FEES]: "Protocol fees retained by Valdora after user yield distributions.",
  },
  ProtocolRevenue: {
