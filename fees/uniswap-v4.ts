...
const Configs: Record<string, IUniswapConfig> = {
  ...
  //   subgraph: sdk.graph.modifyEndpoint('DiYPVdygkfjDWhbxGSqAQxwBKmfKnkWQojqeM2rkLb3G'),
  //   start: '2025-01-24',
  // },
  [CHAIN.UNICHAIN]: {
    poolManager: '0x1f98400000000000000000000000000000000004',
    positionManager: '0x4529a01c7a0410167c5740c487a8de60232617bf',
    // subgraph: sdk.graph.modifyEndpoint('Bd8UnJU8jCRJKVjcW16GHM3FNdfwTojmWb3QwSAmv8Uc'),
    // subgraph: sdk.graph.modifyEndpoint('aa3YpPCxatg4LaBbLFuv2iBC8Jvs9u3hwt5GTpS4Kit'),
    start: '2025-01-24',
  },
  // [CHAIN.OPTIMISM]: {
  //   poolManager: '0x9a13f98cb987694c9f086b1f5eb990eea8264ec3',
  //   positionManager: '0x3c3ea4b57a46241e54610e5f022e5c45859a1017',
  //   subgraph: sdk.graph.modifyEndpoint('6RBtsmGUYfeLeZsYyxyKSUiaA6WpuC69shMEQ1Cfuj9u'),
  //   start: '2025-01-24',
  // },
  // [CHAIN.BASE]: {
  //   poolManager: '0x498581ff718922c3f8e6a244956af099b2652b2b',
  //   positionManager: '0x7c5f5a4bbd8fd63184577525326123b519429bdc',
  //   // subgraph: sdk.graph.modifyEndpoint('HNCFA9TyBqpo5qpe6QreQABAA1kV8g46mhkCcicu6v2R'),
  //   start: '2025-01-24',
  // },
  // [CHAIN.ARBITRUM]: {
  //   poolManager: '0x360e68faccca8ca495c1b759fd9eee466db9fb32',
  //   positionManager: '0xd88f38f930b7952f2db2432cb002e7abbf3dd869',
  //   // subgraph: sdk.graph.modifyEndpoint('G5TsTKNi8yhPSV7kycaE23oWbqv9zzNqR49FoEQjzq1r'),
  //   start: '2025-01-24',
  // },
  // [CHAIN.POLYGON]: {
  //   poolManager: '0x67366782805870060151383f4bbff9dab53e5cd6',
  //   positionManager: '0x1ec2ebf4f37e7363fdfe3551602425af0b3ceef9',
  //   subgraph: sdk.graph.modifyEndpoint('CwpebM66AH5uqS5sreKij8yEkkPcHvmyEs7EwFtdM5ND'),
  //   start: '2025-01-24',
  // },
  // [CHAIN.BLAST]: {
  //   poolManager: '0x1631559198a9e474033433b2958dabc135ab6446',
  //   positionManager: '0x4ad2f4cca2682cbb5b950d660dd458a1d3f1baad',
  //   subgraph: sdk.graph.modifyEndpoint('FCHYK3Ab6bBnkfeCKRhFbs1Q8rX4yt6rKJibpDTC74ns'),
  //   start: '2025-01-24',
  // },
  // [CHAIN.ZORA]: {
  ...
  //   subgraph: sdk.graph.modifyEndpoint('49JxRo9FGxWpSf5Y5GKQPj5NUpX2HhpoZHpGzNEWQZjq'),
  //   start: '2025-01-24',
  // },
  // [CHAIN.BSC]: {
  //   poolManager: '0x28e2ea090877bf75740558f6bfb36a5ffee9e9df',
  //   positionManager: '0x7a4a5c919ae2541aed11041a1aeee68f1287f95b',
  //   subgraph: sdk.graph.modifyEndpoint('2qQpC8inZPZL4tYfRQPFGZhsE8mYzE67n5z3Yf5uuKMu'),
  //   start: '2025-01-24',
  // },
}
...
async function fetch(options: FetchOptions) {
  ...
  if (Configs[options.chain].subgraph) {
    const response = (await httpPost(Configs[options.chain].subgraph as string, {
      query: `
        {
          before: poolManagers(first: 1, block: { number: ${options.fromApi.block} }) {
            totalFeesUSD
          }
          after: poolManagers(first: 1, block: { number: ${options.toApi.block} }) {
            totalFeesUSD
          }
        }
      `
    ...
    if (response.data) {
      dailyFees.addUSDValue(Number(response.data.after[0].totalFeesUSD) - Number(response.data.before[0].totalFeesUSD))
    }
  } else {
    console.log(1)
    ...
    for (const event of events) {
      ...
      if (token === '0x0000000000000000000000000000000000000000') {
        dailyFees.addGasToken(Math.abs(Number(event.amount0)) * (Number(event.fee) / 1e6))
        dailyVolume.addGasToken(Math.abs(Number(event.amount0)))
      } else {
