...
const config: any = {
  ethereum: { tokens: [ADDRESSES.ethereum.USDC], targets: ['0x163c5e051049e92915017fe7bb9b8ce6182bcbb1', '0x6460d14dbaeb27aefec8ebef85db35defa31c3b9'] },
  optimism: { tokens: [ADDRESSES.optimism.USDC_CIRCLE], targets: ['0xd4ce1f1b8640c1988360a6729d9a73c85a0c80a3'] },
  polygon: { tokens: [ADDRESSES.polygon.USDC], targets: ['0xce946931adf7afc0797de2a76270a28458f487ed'] },
