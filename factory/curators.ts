...
const configs: Record<string, CuratorConfig> = {
  ...
  "euler-dao": {
    vaults: {
      ...
      // [CHAIN.MONAD]: { eulerVaultOwners: ['0x5D42F8aCd567810D57D60f90bB9C6d194207a6e1'], start: '2025-11-28' }, operated by k3 now: https://forum.euler.finance/t/sunsetting-of-dao-managed-market-and-vaults/1828
    },
  },
  "feather": {
    vaults: {
